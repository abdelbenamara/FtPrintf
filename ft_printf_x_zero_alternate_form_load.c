...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   ft_printf_x_zero_alternate_form_load.c             :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: abenamar <abenamar@student.42.fr>          +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/02/05 18:30:00 by abenamar          #+#    #+#             */
/*   Updated: 2023/05/02 02:06:12 by abenamar         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	load(void)
{
	...
	nb = ft_printf("%0#35x %0#70x %0#890x" EOL, x[5], x[6], x[7]);
	printf("%d" EOL, nb);
	nb = printf("%0#35x %0#70x %0#890x" EOL, x[5], x[6], x[7]);
	printf("%d" EOL, nb);
}
